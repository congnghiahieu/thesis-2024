...
%
\title{Phát hiện và phân loại mã độc dựa trên các kỹ thuật học sâu}	%% title
...
\begin{center}
	...
	\textbf{PHÁT HIỆN VÀ PHÂN LOẠI MÃ ĐỘC DỰA TRÊN CÁC KỸ THUẬT HỌC SÂU}
	\\[2.6cm]
...
\end{center}
\vspace{16mm}
\textbf{ Cán bộ hướng dân: PGS. TS. Võ Đình Hiếu}
\vfill
\begin{center}
	\textbf{HÀ NỘI - 2018}
	\vspace{10mm}
