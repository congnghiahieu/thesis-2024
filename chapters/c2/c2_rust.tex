...
\textbf{Thread safe}. Lập trình đa luồng trong Rust được đảm bảo an toàn nhờ mô hình ownership và \textit{borrowing}, ngăn chặn tương tranh dữ liệu, bế tắc (deadlock) ngay từ khi biên dịch.
