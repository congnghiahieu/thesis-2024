...
Do trình biên dịch không thể biết được trong khi thực thi hàm \texttt{longest} thì giá trị trả về sẽ trỏ tới vùng nhớ của \texttt{x} hay \texttt{y}, do đó cần phải chỉ rõ lifetime cho giá trị trả về.
...
Ownership, borrowing và lifetime là 3 tính năng làm nên cơ chế an toàn về bộ nhớ trong Rust.
